...
const MainSection = () => {
  return (
    <main>
      <div class="relative px-6 lg:px-8 flex">
        <div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
          <div>
            <div class="hidden sm:mb-8 sm:flex sm:justify-center"></div>
            <div>
              <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl main-heading">
                The only NFT <br />
        ...
        <div className="mx-auto max-w-3xl pt-20">
          <img src="/images/NFT Frame Art 1 (1).png" alt="img" />
        </div>
      </div>
    </main>
  );
